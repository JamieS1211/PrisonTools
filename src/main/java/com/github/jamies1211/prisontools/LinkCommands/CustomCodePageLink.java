 ...
 */
public class CustomCodePageLink implements CommandExecutor {

	@Override
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		String url = "pixelmonweb.officialtjp.com/custom-code/";
		...
		try {
			...
			Text message = (Text.builder()
					.append(TextSerializers.FORMATTING_CODE.deserialize("&8Please click the link to go to the custom code info page &9%url%".replace("%url%", url)))
