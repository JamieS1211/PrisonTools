 ...
 */
public class GuidesPageLink implements CommandExecutor {

	@Override
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		String url = "pixelmonweb.officialtjp.com/forum/guides";
		...
		try {
			...
			Text message = (Text.builder()
					.append(TextSerializers.FORMATTING_CODE.deserialize("&8Please click the link to go to the guides page &9%url%".replace("%url%", url)))
