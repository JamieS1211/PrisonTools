 ...
 */
public class PageLink implements CommandExecutor {
	...
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		...
		try {
			...
			Text message = (Text.builder()
					.append(TextSerializers.FORMATTING_CODE.deserialize("&8Please click the link to go to the detailed page &9%url%".replace("%url%", url)))
