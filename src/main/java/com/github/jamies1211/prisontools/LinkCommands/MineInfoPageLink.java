 ...
 */
public class MineInfoPageLink implements CommandExecutor {

	@Override
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		String url = "pixelmonweb.officialtjp.com/mines-info/";
		...
		try {
			...
			Text message = (Text.builder()
					.append(TextSerializers.FORMATTING_CODE.deserialize("&8Please click the link to go to the mine info page &9%url%".replace("%url%", url)))
